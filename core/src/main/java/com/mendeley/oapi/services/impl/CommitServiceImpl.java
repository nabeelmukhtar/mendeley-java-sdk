...
import com.mendeley.oapi.services.CommitService;
 ...
 */
public class CommitServiceImpl extends BaseMendeleyService implements
		CommitService {
	...
	public Commit getCommit(String userName, String repositoryName, String sha) {
		MendeleyApiUrlBuilder builder = createGitHubApiUrlBuilder(MendeleyApiUrls.CommitApiUrls.GET_COMMIT_URL);
	...
	public List<Commit> getCommits(String userName, String repositoryName,
		...
		MendeleyApiUrlBuilder builder = createGitHubApiUrlBuilder(MendeleyApiUrls.CommitApiUrls.GET_COMMITS_URL);
	...
	public List<Commit> getCommits(String userName, String repositoryName,
		...
		MendeleyApiUrlBuilder builder = createGitHubApiUrlBuilder(MendeleyApiUrls.CommitApiUrls.GET_COMMITS_FILE_URL);
