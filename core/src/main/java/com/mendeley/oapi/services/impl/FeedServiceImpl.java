 ...
 */
public class FeedServiceImpl extends BaseMendeleyService implements
		FeedService {
	...
	public Feed getCommitFeed(String userName, String repositoryName, String branchName, int count) {
		MendeleyApiUrlBuilder builder = createGitHubApiUrlBuilder(MendeleyApiUrls.FeedUrls.GET_COMMIT_FEED_URL);
	...
	public Feed getNetworkFeed(String userName, String repositoryName, int count) {
		MendeleyApiUrlBuilder builder = createGitHubApiUrlBuilder(MendeleyApiUrls.FeedUrls.GET_NETWORK_FEED_URL);
	...
	public Feed getPrivateUserFeed(String userName, int count) {
		MendeleyApiUrlBuilder builder = createGitHubApiUrlBuilder(MendeleyApiUrls.FeedUrls.GET_PRIVATE_USER_FEED_URL);
	...
	public Feed getPublicTimelineFeed(int count) {
		MendeleyApiUrlBuilder builder = createGitHubApiUrlBuilder(MendeleyApiUrls.FeedUrls.GET_PUBLIC_TIMELINE_FEED_URL);
	...
	public Feed getPublicUserFeed(String userName, int count) {
		MendeleyApiUrlBuilder builder = createGitHubApiUrlBuilder(MendeleyApiUrls.FeedUrls.GET_PUBLIC_USER_FEED_URL);
        String                apiUrl  = builder.withField(ParameterNames.USER_NAME, userName).withParameter(ParameterNames.NUM, String.valueOf(count)).buildUrl();
        return unmarshall(apiUrl);
	}
	...
	public Feed getWikiFeed(String userName, String repositoryName, int count) {
		MendeleyApiUrlBuilder builder = createGitHubApiUrlBuilder(MendeleyApiUrls.FeedUrls.GET_WIKI_FEED_URL);
        String                apiUrl  = builder.withField(ParameterNames.USER_NAME, userName).withField(ParameterNames.REPOSITORY_NAME, repositoryName).withParameter(ParameterNames.NUM, String.valueOf(count)).buildUrl();
        return unmarshall(apiUrl);
	}
	...
	public Feed getBlogFeed(int count) {
		MendeleyApiUrlBuilder builder = createGitHubApiUrlBuilder(MendeleyApiUrls.FeedUrls.GET_BLOG_FEED_URL);
        String                apiUrl  = builder.withParameter(ParameterNames.NUM, String.valueOf(count)).buildUrl();
        return unmarshall(apiUrl);
	}
	...
	public Feed getDiscussionsFeed(int count) {
		MendeleyApiUrlBuilder builder = createGitHubApiUrlBuilder(MendeleyApiUrls.FeedUrls.GET_DISCUSSIONS_FEED_URL);
        String                apiUrl  = builder.withParameter(ParameterNames.NUM, String.valueOf(count)).buildUrl();
        return unmarshall(apiUrl);
	}
	...
	public Feed getDiscussionsFeed(String topic, int count) {
		MendeleyApiUrlBuilder builder = createGitHubApiUrlBuilder(MendeleyApiUrls.FeedUrls.GET_DISCUSSIONS_FEED_BY_TOPIC_URL);
	...
	public Feed getJobPositionsFeed(int count) {
		MendeleyApiUrlBuilder builder = createGitHubApiUrlBuilder(MendeleyApiUrls.FeedUrls.GET_JOB_POSITIONS_FEED_URL);
        String                apiUrl  = builder.withParameter(ParameterNames.NUM, String.valueOf(count)).buildUrl();
        return unmarshall(apiUrl);
	}
