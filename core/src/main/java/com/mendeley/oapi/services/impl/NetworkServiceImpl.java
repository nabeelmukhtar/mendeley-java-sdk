...
import com.mendeley.oapi.services.NetworkService;
 ...
 */
public class NetworkServiceImpl extends BaseMendeleyService implements
		NetworkService {
	...
	public List<NetworkCommit> getNetworkData(String userName, String repositoryName,
			String networkHash) {
		MendeleyApiUrlBuilder builder = createGitHubApiUrlBuilder(MendeleyApiUrls.NetworkApiUrls.GET_NETWORK_DATA_URL);
	...
	public NetworkMeta getNetworkMeta(String userName, String repositoryName) {
		MendeleyApiUrlBuilder builder = createGitHubApiUrlBuilder(MendeleyApiUrls.NetworkApiUrls.GET_NETWORK_META_URL);
