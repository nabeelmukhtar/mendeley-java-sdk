...
import com.mendeley.oapi.schema.Team;
import com.mendeley.oapi.schema.User;
import com.mendeley.oapi.services.OrganizationService;
 ...
 */
public class OrganizationServiceImpl extends BaseMendeleyService implements
		OrganizationService {
	...
	public void addTeamMember(String teamId, String userName) {
		MendeleyApiUrlBuilder builder = createGitHubApiUrlBuilder(MendeleyApiUrls.OrganizationApiUrls.ADD_TEAM_MEMBER_URL);
	...
	public void addTeamRepository(String teamId, String userName, String repositoryName) {
		MendeleyApiUrlBuilder builder = createGitHubApiUrlBuilder(MendeleyApiUrls.OrganizationApiUrls.ADD_TEAM_REPOSITORY_URL);
        String                apiUrl  = builder.withField(ParameterNames.TEAM_ID, teamId).buildUrl();
        Map<String, String> parameters = new HashMap<String, String>();
	...
	public Team createTeam(String organizationName, String teamName, Permission permission, List<String> repoNames) {
		MendeleyApiUrlBuilder builder = createGitHubApiUrlBuilder(MendeleyApiUrls.OrganizationApiUrls.CREATE_TEAM_URL);
	...
	public void deleteTeam(String teamId) {
		MendeleyApiUrlBuilder builder = createGitHubApiUrlBuilder(MendeleyApiUrls.OrganizationApiUrls.DELETE_TEAM_URL);
        String                apiUrl  = builder.withField(ParameterNames.TEAM_ID, teamId).buildUrl();
	...
	public List<Repository> getAllOrganizationRepositories() {
		MendeleyApiUrlBuilder builder = createGitHubApiUrlBuilder(MendeleyApiUrls.OrganizationApiUrls.GET_ALL_REPOSITORIES_URL);
	...
	public Organization getOrganization(String name) {
		MendeleyApiUrlBuilder builder = createGitHubApiUrlBuilder(MendeleyApiUrls.OrganizationApiUrls.GET_ORGANIZATION_URL);
	...
	public List<User> getPublicMembers(String organizationName) {
		MendeleyApiUrlBuilder builder = createGitHubApiUrlBuilder(MendeleyApiUrls.OrganizationApiUrls.GET_PUBLIC_MEMBERS_URL);
        String                apiUrl  = builder.withField(ParameterNames.ORGANIZATION_NAME, organizationName).buildUrl();
        JsonObject json = unmarshall(callApiGet(apiUrl));
	...
	public List<Repository> getPublicRepositories(String organizationName) {
		MendeleyApiUrlBuilder builder = createGitHubApiUrlBuilder(MendeleyApiUrls.OrganizationApiUrls.GET_PUBLIC_REPOSITORIES_URL);
        String                apiUrl  = builder.withField(ParameterNames.ORGANIZATION_NAME, organizationName).buildUrl();
        JsonObject json = unmarshall(callApiGet(apiUrl));
	...
	public Team getTeam(String teamId) {
		MendeleyApiUrlBuilder builder = createGitHubApiUrlBuilder(MendeleyApiUrls.OrganizationApiUrls.GET_TEAM_URL);
        String                apiUrl  = builder.withField(ParameterNames.TEAM_ID, teamId).buildUrl();
        JsonObject json = unmarshall(callApiGet(apiUrl));
	...
	public List<User> getTeamMembers(String teamId) {
		MendeleyApiUrlBuilder builder = createGitHubApiUrlBuilder(MendeleyApiUrls.OrganizationApiUrls.GET_TEAM_MEMBERS_URL);
        String                apiUrl  = builder.withField(ParameterNames.TEAM_ID, teamId).buildUrl();
        JsonObject json = unmarshall(callApiGet(apiUrl));
	...
	public List<Repository> getTeamRepositories(String teamId) {
		MendeleyApiUrlBuilder builder = createGitHubApiUrlBuilder(MendeleyApiUrls.OrganizationApiUrls.GET_TEAM_REPOSITORIES_URL);
        String                apiUrl  = builder.withField(ParameterNames.TEAM_ID, teamId).buildUrl();
        JsonObject json = unmarshall(callApiGet(apiUrl));
	...
	public List<Team> getTeams(String organizationName) {
		MendeleyApiUrlBuilder builder = createGitHubApiUrlBuilder(MendeleyApiUrls.OrganizationApiUrls.GET_TEAMS_URL);
        String                apiUrl  = builder.withField(ParameterNames.ORGANIZATION_NAME, organizationName).buildUrl();
        JsonObject json = unmarshall(callApiGet(apiUrl));
	...
	public List<Organization> getUserOrganizations() {
		MendeleyApiUrlBuilder builder = createGitHubApiUrlBuilder(MendeleyApiUrls.OrganizationApiUrls.GET_ORGANIZATIONS_URL);
        String                apiUrl  = builder.buildUrl();
        JsonObject json = unmarshall(callApiGet(apiUrl));
	...
	public void removeTeamMember(String teamId, String userName) {
		MendeleyApiUrlBuilder builder = createGitHubApiUrlBuilder(MendeleyApiUrls.OrganizationApiUrls.REMOVE_TEAM_MEMBER_URL);
	...
	public void removeTeamRepository(String teamId, String userName, String repositoryName) {
		MendeleyApiUrlBuilder builder = createGitHubApiUrlBuilder(MendeleyApiUrls.OrganizationApiUrls.REMOVE_TEAM_REPOSITORY_URL);
	...
	public void updateOrganization(Organization organization) {
		MendeleyApiUrlBuilder builder = createGitHubApiUrlBuilder(MendeleyApiUrls.OrganizationApiUrls.UPDATE_ORGANIZATION_URL);
	...
	public void updateTeam(Team team) {
		MendeleyApiUrlBuilder builder = createGitHubApiUrlBuilder(MendeleyApiUrls.OrganizationApiUrls.UPDATE_TEAM_URL);
